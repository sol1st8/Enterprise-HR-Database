...
class Worker {
  public:
    ...
    virtual void DeleteBusinessTrip(const domain::BusinessTrip& trip) = 0;
    ...
    virtual void DeleteEmployee(const domain::Employee& employee) = 0;
    ...
    virtual void DeleteOrder(const domain::Order& order) = 0;
